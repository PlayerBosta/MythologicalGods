package com.playerbosta.mythologyunleashed.client.screen;

import com.mojang.blaze3d.systems.RenderSystem;
import com.playerbosta.mythologyunleashed.MythologyUnleashed;
import com.playerbosta.mythologyunleashed.client.data.SkillTexturesData;
...
import com.playerbosta.mythologyunleashed.client.widget.*;
import com.playerbosta.mythologyunleashed.client.widget.Button;
import com.playerbosta.mythologyunleashed.registers.PSTSkillBonuses;
...
public class SkillTreeEditorScreen extends Screen {
  ...
  private void createNewSkill(float x, float y, @Nullable PassiveSkill other) {
    ResourceLocation background =
        new ResourceLocation(MythologyUnleashed.MODID, "textures/icons/background/lesser.png");
    ResourceLocation icon = new ResourceLocation(MythologyUnleashed.MODID, "textures/icons/void.png");
    ResourceLocation border =
        new ResourceLocation(MythologyUnleashed.MODID, "textures/tooltip/lesser.png");
